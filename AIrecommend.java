public class AIrecommend{
  private String a = "";
  private String[] list = new String[]{"ways of having a healthy lifestyle", "effective study methods", "managing time better", "movies to watch"};
  ...
  private String[] actionMovies = new String[]{"Spider-Man: No Way Home", "Avengers: Endgame", "Black Adam", "The Batman", "Avatar", "Ready Player One", "Red Notice"};
...
String answer="";
  ...
  else if(selection.toUpperCase().indexOf("ACTION MOVIES")!=-1){
    index = (int)(Math.random()*(actionMovies.length-2+1)+1);
    answer+="I recommend watching "+actionMovies[index];
  }
  return answer+"\nAnything else you want me to do?";
}
}